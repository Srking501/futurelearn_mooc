...
run2_empty_id = cyber.security.1_question.response %>% select(learner_id) %>%
    filter(learner_id == "") %>% count() %>% 
    select(n) %>% rename("Total number of empty `learner_id` in Run 2" = n)
run3_empty_id = cyber.security.1_question.response %>% select(learner_id) %>%
    filter(learner_id == "") %>% count() %>% 
    select(n) %>% rename("Total number of empty `learner_id` in Run 3" = n)
run4_empty_id = cyber.security.1_question.response %>% select(learner_id) %>%
    filter(learner_id == "") %>% count() %>% 
    select(n) %>% rename("Total number of empty `learner_id` in Run 4" = n)
run5_empty_id = cyber.security.1_question.response %>% select(learner_id) %>%
    filter(learner_id == "") %>% count() %>% 
    select(n) %>% rename("Total number of empty `learner_id` in Run 5" = n)
run6_empty_id = cyber.security.1_question.response %>% select(learner_id) %>%
    filter(learner_id == "") %>% count() %>% 
    select(n) %>% rename("Total number of empty `learner_id` in Run 6" = n)
run7_empty_id = cyber.security.1_question.response %>% select(learner_id) %>%
    filter(learner_id == "") %>% count() %>% 
